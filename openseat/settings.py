"""
Django settings for openseat project.
...
SECRET_KEY = 'django-insecure-#@xa)k67&lzm4!p7g4@z3g(hcjlwyo@iau=z)=b&r$&zdm6v@w'
...
MIDDLEWARE = [
    ...
    'trains.middleware.RateLimitMiddleware',
...
WSGI_APPLICATION = 'openseat.wsgi.application'
